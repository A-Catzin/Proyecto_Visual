...
public class PanelGestionUsuarios extends javax.swing.JPanel {
    ...
    private void configurarEventos() {
        ...
        // mensaje)
        jButton4.addActionListener(e -> JOptionPane.showMessageDialog(this, "Funcionalidad no implementada aún."));
    }
    ...
    private void llenarCamposDesdeTabla() {
        ...
        if (fila != -1) {
            // ID, Usuario, Nombre, Email, Teléfono, Rol, Estado
            jTextField1
                    .setText(modeloTabla.getValueAt(fila, 1) != null ? modeloTabla.getValueAt(fila, 1).toString() : ""); // Usuario
            jTextField5
                    .setText(modeloTabla.getValueAt(fila, 2) != null ? modeloTabla.getValueAt(fila, 2).toString() : ""); // Nombre
            jTextField4
                    .setText(modeloTabla.getValueAt(fila, 3) != null ? modeloTabla.getValueAt(fila, 3).toString() : ""); // Email
            jTextField3
                    .setText(modeloTabla.getValueAt(fila, 4) != null ? modeloTabla.getValueAt(fila, 4).toString() : ""); // Teléfono

            String rol = modeloTabla.getValueAt(fila, 5) != null ? modeloTabla.getValueAt(fila, 5).toString()
                    : "Cliente";
            jComboBox2.setSelectedItem(rol);

            String estado = modeloTabla.getValueAt(fila, 6) != null ? modeloTabla.getValueAt(fila, 6).toString()
                    : "Activo";
    ...
    private void modificarUsuario() {
        ...
        if (password.isEmpty()) {
            ...
            // Avisaré.
            JOptionPane.showMessageDialog(this, "Para modificar, reingrese la contraseña o ingrese una nueva.", "Aviso",
                    JOptionPane.WARNING_MESSAGE);
            return;
        }
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(
                new javax.swing.DefaultComboBoxModel<>(new String[] { "Cliente", "Administrador", "Operador" }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        jComboBox3
                .setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Activo", "Inactivo", "Suspendido" }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
